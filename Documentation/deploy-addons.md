...
[k8s-dns-addon]: https://github.com/kubernetes/kubernetes/tree/v1.4.5/cluster/addons/dns
...
kind: ReplicationController
metadata:
  name: kubernetes-dashboard-v1.4.5
  namespace: kube-system
  labels:
  ...
  template:
    ...
    spec:
      ...
      - name: kubernetes-dashboard
        image: gcr.io/google_containers/kubernetes-dashboard-amd64:v1.4.5
        resources:
          limits:
            cpu: 100m
            memory: 50Mi
...
$ kubectl port-forward kubernetes-dashboard-v1.4.5-SOME-ID 9090 --namespace=kube-system
```
